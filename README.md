...
Spreadsheet-style web tracker for Pikmin Bloom flower planting stats. Data syncs through a GitHub Gist; the site deploys on GitHub Pages.
...
| total F | est. F + avg remain F; if &lt; 0 set to 0, other colors rescale to flower target; rounded to int |
...
Default flower target is **15000**.
